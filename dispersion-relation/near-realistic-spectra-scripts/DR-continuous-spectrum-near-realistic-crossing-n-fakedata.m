...
filenamepostfix="-fakedata";

dataFakeCrossing = {{-1, -1.3}, {-0.8, -1.0}, {-0.7, -0.8}, {-0.6, \
-0.3}, {-0.5, -0.1}, {0, 0.5}, {0.5, 8}, {1, 6}}
...
okMAAdata=Table[
{n SpectrumOmegaNMAA[n, 1, -1, spectFun],
 SpectrumOmegaNMAA[n, 1, -1, spectFun]},

{n,-0.99999999,0.9999999,0.001}
...
okMZApdata=Table[
{n SpectrumOmegaNMZA[n, 1, -1, spectFun][[1]],
...
okMZAmdata=Table[
{n SpectrumOmegaNMZA[n, 1, -1, spectFun][[2]],
