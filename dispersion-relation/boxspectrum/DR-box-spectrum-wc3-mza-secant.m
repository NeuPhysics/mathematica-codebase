...
{
   omegareal,
   k/.FindRoot[ConAxialSymOmegaNMZAmEqnLHSComplex[omegareal, k, spectrum], {k, -I, I}, Method->"Secant", MaxIterations -> 1000000,AccuracyGoal->5]
},
{omegareal,mrangeomegareal[[1]],mrangeomegareal[[2]],0.01}
]//Quiet

Export["mzamlsadata-box-spectrum"<>filenamepostfix<>"-secant.csv",Flatten@#&/@mzamlsadata]
Print["Exported mazamlsadata-box-spectrum"<>filenamepostfix<>"-secant.csv"]
