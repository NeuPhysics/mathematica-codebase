...
spectFunCos[u_]= 1.5 Cos[u Pi/2] - 0.5;

(* change the following parameters *)
stepsize=2;
filenamepostfix="-cos-c-rok-test";
...
maalsalandscape=Table[ {omega,k, SpectrumOmegaKMAAEqnLHSComplex[omega,0,k,0,spectrum]}, {omega, -4.499, 4.499, stepsize}, {k, -4.499, 4.499 , stepsize}]
