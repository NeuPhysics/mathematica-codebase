...
filenamepostfix="-cos-wc-forward-01";

spectFun[u_] = Piecewise[{{ 1.5 Cos[u Pi/2] - 0.5 , 0 <= u <= 1} }, 0];
low = 0;
upper = 1;
...
okMAAdata=Table[ {n SpectrumOmegaNMAA[n, low, upper, spectFun], SpectrumOmegaNMAA[n, low, upper, spectFun]}, {n,-0.99999999,0.9999999,0.01} ]
