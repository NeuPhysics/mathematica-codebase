...
okMAAdata=Table[ {n SpectrumOmegaNMAA[n, 1, -1, spectFun], SpectrumOmegaNMAA[n, 1, -1, spectFun]}, {n,-0.99999999,0.9999999,0.001} ]

Export["okMAAdata"<>filenamepostfix<>".csv",okMAAdata]

Print["Exported okMAAdata"<>filenamepostfix<>".csv"]

okMZApdata=Table[ {n SpectrumOmegaNMZA[n, 1, -1, spectFun][[1]], SpectrumOmegaNMZA[n, 1, -1, spectFun][[1]]}, {n,-0.99999999,0.9999999,0.001} ]
...
okMZAmdata=Table[{n SpectrumOmegaNMZA[n, 1, -1, spectFun][[2]], SpectrumOmegaNMZA[n, 1, -1, spectFun][[2]]}, {n,-0.99999999,0.9999999,0.001}]
